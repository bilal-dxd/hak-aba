...
// Traitement de la requête POST pour placer une commande
...
// Vérification du contenu du panier (cart)
         ...
         <div class="flex">
            <div class="box">
               ...
               <select name="method" class="input" required>
                  ...
                  <option value="We Pay By CIH">We Pay By CIH</option>
            ...
            <div class="box">
               ...
               <input type="t ext" name="flat" required maxlength="50" placeholder="e.g. flat & building number" class="input">
      ...
      <div class="summary">
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"></i> <?= $fetch_get['price']; ?> MAD x 1</p>
            </div>
         </div>
         <?php
               }
         ...
         <div class="flex">
            ...
            <div>
               ...
               <p class="price"> <?= $fetch_product['price']; ?> MAD x <?= $fetch_cart['qty']; ?></p>
            </div>
         </div>
         <?php
                  }
         ...
         ?>
         <div class="grand-total"><span>grand total :</span><p> <?= $grand_total; ?></p></div>
      </div>
